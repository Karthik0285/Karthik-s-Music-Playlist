...
const music_list = [
    ...
    },
    {
        ...
        music: 'Spirit Of Jersey.mp3'
    },
    {
        img: 'Jailer.png',
        name: 'Jailer',
        artist: 'Anirudh Ravichander',
        music: 'Hukum Tiger Ka Hukum.mp3'
    },
    {
        img: 'Gentleman.png',
        name: 'Chali Gaali Chuudduu',
        artist: 'Haricharan',
        music: 'Chali Gaali Chuudduu.mp3'
    }
];
...
function loadTrack(track_index) {
    ...
    track_image.src = music_list[track_index].img;
    track_image.alt = "Track Image"; 
    track_image.loading = "lazy";
